...
@Component({
  selector: 'app-editor-commands',
  templateUrl: './editor-commands.component.html',
  styleUrls: ['./editor-commands.component.scss'],
})
export class EditorCommandsComponent implements OnInit {
