...
export const services = {
  ...
  signUrl: { url: '/attachments/signUrl', type: 'GET' },
  ...
  searchIssues: { url: '/issues/project/{id}', type: 'GET' },
  ...
  createBugIssueFromTestCase: { url: '/issues/testIssue/createBugIssue', type: 'POST' },
